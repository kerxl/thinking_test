...
async def generate_random_user() -> SimulatedUser:
    ...
    first_names = [
        ...
        "Михаил", "Татьяна", "Владимир", "Наталья", "Александр", "Ирина", "Максим", "Юлия"
    ]
    
    male_last_names = [
        "Иванов", "Петров", "Сидоров", "Козлов", "Новиков", "Морозов", "Попов", "Волков",
        "Соколов", "Лебедев", "Семенов", "Егоров", "Павлов", "Захаров", "Степанов", "Николаев"
    ]
    
    female_last_names = [
        "Иванова", "Петрова", "Сидорова", "Козлова", "Новикова", "Морозова", "Попова", "Волкова",
        "Соколова", "Лебедева", "Семенова", "Егорова", "Павлова", "Захарова", "Степанова", "Николаева"
    ]
